...
import { sendMessage, listMessages, generateResponse, getTodaySummary, listHistory } from "../controllers/chatController.js";
...
chatRoutes.get("/history", requireAuth, asyncHandler(listHistory));
